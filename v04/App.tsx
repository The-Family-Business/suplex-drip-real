...
import { X, ArrowLeft, Download, FileJson, CheckCircle, PenTool, Play } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleBubbleClick = (index: number) => {
    ...
    if (targetQuestionIndex < 0 || targetQuestionIndex >= activeQuestions.length) return;
              ...
              <AnimatePresence>
                {!isTyping && messages[messages.length - 1].sender === 'bot' && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: 20 }}
                      // Disable interaction in Edit Mode to prevent answering while editing questions
