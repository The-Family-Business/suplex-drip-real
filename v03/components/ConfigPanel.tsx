    ...
    <div className="bg-white/95 backdrop-blur-md border-l border-gray-200 w-full md:w-80 h-full overflow-y-auto p-6 shadow-2xl z-50 flex flex-col gap-8">
      ...
      <div className="space-y-4">
        ...
        <RangeInput 
          ...
          value={theme.sizing.buttonFontSize} 
          min={12} max={32} step={1}
          displayValue={theme.sizing.buttonFontSize + 'px'}
          onChange={(v) => handleSizingChange('buttonFontSize', v)}
        />

        <RangeInput 
          label="Min Button Height" 
          value={theme.sizing.minButtonHeight} 
          min={40} max={160} step={5}
          displayValue={theme.sizing.minButtonHeight + 'px'}
          onChange={(v) => handleSizingChange('minButtonHeight', v)}
        />
