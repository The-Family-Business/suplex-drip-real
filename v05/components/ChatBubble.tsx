  ...
  return (
    <motion.div
      ...
      style={{
        ...
        pointerEvents: isHistory ? 'auto' : 'none' // Ensure only history items that are visible are clickable, though container manages this mostly
      }}
      whileHover={isHistory ? { scale: 1.02, filter: 'blur(0px)', opacity: 0.9 } : undefined}
    >
      <div
        style={{
          maxWidth: '90%',
