...
export const DEFAULT_THEME: ThemeConfig = {
  ...
  sizing: {
    baseFontSize: 24, // Updated from 22
    buttonFontSize: 19, // Updated from 18
    cardBorderRadius: 28, // Updated from 68
    cardPadding: 24,
    borderWidth: 8,
    bubbleBorderRadius: 24,
    minButtonHeight: 45, // Updated from 80
    containerMaxWidth: "1000px",
    aiSuggestionFontSize: 29 // Updated from 28
  },
  physics: {
    stiffness: 300, 
    damping: 15,
...
export const QUESTIONS: Question[] = [
  ...
  // 5. Business Structure
  {
    ...
    options: [
      { id: "saas", label: "SaaS", value: "saas", examples: ["Salesforce", "Linear", "Notion", "Slack", "HubSpot"] },
      { id: "vibe_coder", label: "Vibe Coder", value: "vibe_coder", examples: ["Cursor", "Replit", "Windsurf", "v0", "Bolt.new"] },
      { id: "agency", label: "Agency", value: "agency", examples: ["Marketing", "Dev Shop", "Design", "Consulting", "SEO Firm"] },
      { id: "ecommerce", label: "E-Commerce", value: "ecommerce", examples: ["Shopify", "WooCommerce", "Magento", "DTC", "Amazon FBA"] },
      { id: "creator", label: "Creator", value: "creator", examples: ["Skool", "Course Creator", "Influencer", "Paid Community"] },
      { id: "local", label: "Local Biz", value: "local", examples: ["Gym", "Restaurant", "Spa", "Club", "Dental"] },
      { id: "freelance", label: "Freelancer", value: "freelance", examples: ["Copywriter", "Designer", "Developer", "Consultant"] }
    ]
  },
  // 6. Tools
  {
  ...
  // 12. Research Time - NEW
  {
    ...
    type: "choice",
    options: [
        { id: "minimal", label: "0-2 hrs", value: "0-2", examples: ["I wing it"] },
        { id: "light", label: "2-5 hrs", value: "2-5", examples: ["Weekly sourcing"] },
        { id: "heavy", label: "5-15 hrs", value: "5-15", examples: ["Significant effort"] },
        { id: "grind", label: "15+ hrs", value: "15+", examples: ["Full-time grind"] }
    ]
  },
  // 13. Outreach Time - NEW
  {
    ...
    type: "choice",
    options: [
        { id: "minimal", label: "0-2 hrs", value: "0-2", examples: ["Mostly automated"] },
        { id: "light", label: "2-10 hrs", value: "2-10", examples: ["Manual emails"] },
        { id: "heavy", label: "10-20 hrs", value: "10-20", examples: ["Half my week"] },
        { id: "grind", label: "20+ hrs", value: "20+", examples: ["Manual SDR work"] }
    ]
  },
  // 14. Preference
  {
    id: "setup_preference",
    text: "Do you want to get leads, pick a template, or do both?",
    type: "choice",
    options: [
      { id: "leads", label: "Get Leads", value: "leads", examples: ["Find Prospects", "Build List"] },
      { id: "template", label: "Pick Template", value: "template", examples: ["Strategy", "Messaging"] },
      { id: "both", label: "Do Both", value: "both", examples: ["Full Setup", "Launch Now"] }
    ]
  },
